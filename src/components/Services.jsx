...
const Services = () => {
  // Simple animation variants matching Header style
  ...
  return (
    <div id="services" className="w-full px-[12%] py-16 scroll-mt-20 bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <motion.div
          ...
          {serviceData.map(({ icon, title, description, link }, index) => (
            <motion.div
              ...
              className="relative border border-gray-200 dark:border-gray-700 rounded-2xl px-8 py-12
               bg-white dark:bg-gray-800 transition-all duration-500 ease-out
               hover:-translate-y-3 hover:bg-gray-50 dark:hover:bg-gray-700
               hover:shadow-[0_10px_20px_rgba(0,0,0,0.6)] dark:hover:shadow-[0_10px_20px_rgba(255,255,255,0.1)]"
            >
              ...
              <a
                href={link}
                className="flex items-center gap-2 text-sm mt-6 text-pink-500 dark:text-pink-400 hover:text-pink-600 dark:hover:text-pink-300 transition-colors"
              >
